...
I. Mô tả:
I. Mô tả:
Trong môn học này các bạn được yêu cầu xây dựng một quy trình, hệ thống ci/cd và monitor để có thể deploy, vận hành và giám sát được hệ thống “YAS: Yet Another Shop” từ link sau: https://github.com/nashtech-garage/yas
...
Mặc định, các bạn sẽ có 1 image cho tất cả các service với tag là main hoặc latest.
...
Bỏ qua phần này nếu làm phần Nâng Cao: Tương tự, trên Jenkins tạo ra 2 job CI/CD để deploy "dev" và "staging".
main thay đổi, auto sẽ deploy đè liên tục vào trong namespace dev
Staging: trên "main" branch sẽ có đáng tag để có dạng release, ví dụ: tag v1.2.3. thì job CI/CD sẽ phát hiện và build image với tag cuối cùng, ví dụ tag v1.2.3 (hoặc tách branch rc_v1.2.3, hoặc vừa tag và tách branch), sau đó push images này lên Docker Hub và deploy vào trong namespace "staging"
...
2.      Thời gian làm bài 2.5 tuần (22/04/2026)
